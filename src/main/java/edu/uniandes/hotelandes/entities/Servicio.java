...
public enum Servicio {
    ...
    BAR("Bar", 10000, "Bar con una gran variedad de bebidas, con un horario de 6:00 am a 10:00 pm", new ArrayList<Producto>(Arrays.asList(new Producto("Cerveza", 10000), new Producto("Vino", 10000), new Producto("Whisky", 10000)))),
    ...
    BOUTIQUE("Tienda boutique", 10000, "Tienda con una gran variedad de productos, con un horario de 6:00 am a 10:00 pm", new ArrayList<Producto>(Arrays.asList(new Producto("Camisa", 10000), new Producto("Pantalon", 10000), new Producto("Zapatos", 10000)))),
